...
class Spryng_Payments_WC_SEPA_Gateway extends Spryng_Payments_WC_Abstract_Gateway
{
    const METHOD_ID = 'spryng_payments_sepa';

    const DEFAULT_TITLE = 'SEPA';

    const DEFAULT_DESCRIPTION = 'Pay using SEPA Direct Debit';
