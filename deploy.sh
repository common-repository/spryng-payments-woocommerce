...
# main config
PLUGINSLUG="Spryng Payments WooCommerce"
CURRENTDIR=`pwd`
MAINFILE="spryng-payments-woocommerce.php" # this should be the name of your main php file in the wordpress plugin
...
SVNURL="http://plugins.svn.wordpress.org/spryng-payments-woocommerce/" # Remote SVN repo on wordpress.org, with no trailing slash
SVNUSER="spryng" # your svn username
